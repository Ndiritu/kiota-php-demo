...
class MultiValueLegacyExtendedPropertyItemRequestBuilder 
{
    ...
    */
    public function __construct(array $pathParameters, RequestAdapter $requestAdapter) {
        $this->urlTemplate = '{+baseurl}/users/{user_id}/mailFolders/{mailFolder_id}/multiValueExtendedProperties/{multiValueLegacyExtendedProperty_id}{?select,expand}';
    ...
    */
     ...
     * @return RequestInformation
    */
    public function createPatchRequestInformation(MultiValueLegacyExtendedProperty $body, ?array $headers = null, ?array $options = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
    ...
    */
     ...
     * @return Promise
    */
    public function patch(MultiValueLegacyExtendedProperty $body, ?array $headers = null, ?array $options = null, ?ResponseHandler $responseHandler = null): Promise {
